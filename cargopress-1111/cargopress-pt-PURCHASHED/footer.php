		...
		<div class="footer-bottom">
			<div class="container">
				<div class="footer-bottom__left">
					<?php echo apply_filters( 'cargopress/footer_left_txt', get_theme_mod( 'footer_left_txt', '<a href="https://www.proteusthemes.com/wordpress-themes/cargopress/">CargoPress Theme</a> Made by ProteusThemes.' ) ); ?>
				</div>
