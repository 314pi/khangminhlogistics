...
if ( ! class_exists( 'PW_Opening_Time' ) ) {
	class PW_Opening_Time extends PW_Widget {
		...
		public function __construct() {
			...
			$this->days = array(
				'Sun' => esc_html__( 'Chủ Nhật', 'proteuswidgets' ),
				'Mon' => esc_html__( 'Thứ Hai', 'proteuswidgets' ),
				'Tue' => esc_html__( 'Thứ Ba', 'proteuswidgets' ),
				'Wed' => esc_html__( 'Thứ Tư', 'proteuswidgets' ),
				'Thu' => esc_html__( 'Thứ Nam', 'proteuswidgets' ),
				'Fri' => esc_html__( 'Thứ Sáu', 'proteuswidgets' ),
				'Sat' => esc_html__( 'Thứ Bảy', 'proteuswidgets' ),
			);
